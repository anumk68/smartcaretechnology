            ...
            <ul class="info">
                <li><svg width="15" height="12" viewBox="0 0 15 12" fill="none"
                    ...
                    <a href="mailto:contact@smartcaretechnologies.com"
                        class="ms-1">contact@smartcaretechnologies.com</a>
                </li>
                <li class="ms-4"><svg width="16" height="15" viewBox="0 0 16 15" fill="none"
                    ...
                    <a href="tel:+1844 877 4838" class="ms-1">+1844 877 4838 (USA / CANADA)
            ...
            <div class="main-menu">
                <nav>
                    <ul>
                        ...
                        <li class="{{ Route::is('how.we.work') ? 'active' : '' }}">
                            <a href="{{ route('how.we.work') }}">How we work</a>
                        </li>
                        <li class="{{ Route::is('blog') || Route::is('blog.*') ? 'active' : '' }}">
...
<div id="targetElement" class="sidebar-area sidebar__hide">
    ...
    <ul class="info pt-40">
        <li><i class="fa-solid primary-color fa-location-dot"></i> <a href="#">Smart Care Technologies Ltd.
                725 Pelissier St, Windsor
                ON N9A 4L4
                Canada</a>
        </li>
        <li class="py-2"><i class="fa-solid primary-color fa-phone-volume"></i> <a href="tel:+1844 877 4838">+1844 877
                4838 (USA / CANADA)</a>
        </li>
        <li><i class="fa-solid primary-color fa-paper-plane"></i> <a
                href="mailto:contact@smartcaretechnologies.com">contact@smartcaretechnologies.com</a></li>
    </ul>
...
<div class="position-fixed bottom-0 end-0 p-3" style="z-index: 1055">
    ...
    @if (session('success'))
        <div id="successToast" class="toast align-items-center text-dark bg-light border-0 shadow mb-2"
            role="alert" aria-live="assertive" aria-atomic="true" style="border-left: 5px solid #28a745;">
            <div class="d-flex">
    ...
    @endif
    @if (session('error'))
        <div id="errorToast" class="toast show align-items-center text-light bg-danger border-0 shadow mb-2"
            role="alert" aria-live="assertive" aria-atomic="true"
            style="border-left: 5px solid #ac1f2d; min-width: 300px;">
            <div class="d-flex">
                <div class="toast-body">
                    {{ session('error') }}
                </div>
