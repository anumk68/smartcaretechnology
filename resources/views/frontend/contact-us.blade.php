                            ...
                            <ul class="mt-40 mb-40">
                                <li>
                                    ...
                                    <div>
                                        ...
                                        <h3 class="mt-1"><a class="text-white tx" href="tel:+1844 877 4838">+1844 877
                                                4838</a>
                                        </h3>
                                    </div>
                                </li>
                                <li>
                                    ...
                                    <div>
                                        ...
                                        <h3 class="mt-1"><a class="text-white tx"
                                                href="mailto:contact@smartcaretechnologies.com">contact@smartcaretechnologies.com</a>
                                        </h3>
                                    </div>
                                </li>
                                <li>
                                    ...
                                    <div>
                                        ...
                                        <h3 class="mt-1"><a class="text-white tx" href="tel:+2085550112">Smart Care
                                                Technologies Ltd. <br>725 Pelissier St, Windsor ON<br> N9A 4L4 Canada</a>
                                        </h3>
                                    </div>
                                </li>
                            </ul>
                                ...
                                <form action="{{ route('contact.store') }}" method="Post" autocomplete="off">
                                    ...
                                    <div class="row">
                                        <div class="col-6">
                                            ...
                                            <input id="name"
                                                class="bg-transparent bor @error('name') input-danger @enderror"
                                        ...
                                        <div class="col-6">
                                            ...
                                            <input class="bg-transparent bor @error('email') input-error @enderror"
                                    ...
                                    <div class="text-area mt-3">
                                        ...
                                        <textarea class="bg-transparent bor @error('message') input-error @enderror" id="message" name="message"
