    ...
    <main>
        <section class="banner-area">
            <div class="banner__line">
                <img class="sway__animation" src="{{ asset('public/assets/images/banner/banner-line.png') }}" alt="shape">
            </div>
                ...
                <div class="swiper-wrapper">
                    <div class="swiper-slide">
                        <div data-animation="slideInLeft" data-duration="2s" data-delay=".3s" class="banner__shape-left2">
                            <img src="{{ asset('public/assets/images/banner/banner-regular-left-shape.png') }}"
                                alt="shape">
                        </div>
                        <div data-animation="slideInLeft" data-duration="2s" data-delay=".9s" class="banner__shape-left1">
                            <img src="{{ asset('public/assets/images/banner/banner-solid-left-shape.png') }}"
                                alt="shape">
                        </div>
                        <div class="banner__shape-left3 wow slideInLeft">
                            <img class="sway__animation"
                                src="{{ asset('public/assets/images/banner/banner-shape-left.png') }}" alt="shape">
                        </div>
                        <div class="banner__shape-right2" data-animation="slideInRight" data-duration="3s" data-delay=".3s">
                            <img src="{{ asset('public/assets/images/banner/banner-shape-right-line.png') }}"
                                alt="shape">
                        </div>
                        <div class="banner__shape-right1" data-animation="slideInRight" data-duration="2s" data-delay=".3s">
                            <img src="{{ asset('public/assets/images/banner/banner-shape-right.png') }}" alt="shape">
                        </div>
                        <div class="banner__right-line1" data-animation="slideInRight" data-duration="2s" data-delay=".9s">
                            <img src="{{ asset('public/assets/images/banner/banner-right-line1.png') }}" alt="shape">
                        </div>
                        <div class="banner__right-line2" data-animation="slideInRight" data-duration="2s" data-delay=".7s">
                            <img src="{{ asset('public/assets/images/banner/banner-right-line2.png') }}" alt="shape">
                        </div>
                        <div class="banner__right-line3" data-animation="slideInRight" data-duration="2s" data-delay=".5s">
                            <img src="{{ asset('public/assets/images/banner/banner-right-line3.png') }}" alt="shape">
                        </div>
                        <div class="banner__right-line4" data-animation="slideInRight" data-duration="2s" data-delay=".3s">
                            <img src="{{ asset('public/assets/images/banner/banner-right-line4.png') }}" alt="shape">
                        </div>
                        <div class="slide-bg" data-background="{{ asset('public/assets/images/banner/banner-1.jpg') }}">
                        </div>
                        <div class="container">
                            <div class="banner__content">
                                ...
                                <a data-animation="slideInRight" data-duration="2s" data-delay=".9s"
                                    href="{{ route('services') }}" class="btn-one mt-60">Explore
                    ...
                    <div class="swiper-slide">
                        ...
                        <div class="slide-bg" data-background="{{ asset('public/assets/images/banner/banner-2.jpg') }}">
                        </div>
                        <div class="container">
                            <div class="banner__content">
                                <h4 data-animation="slideInRight" data-duration="2s" data-delay=".3s"
        ...
        <section class="service-area pt-120 pb-120">
            <div class="service__shape wow slideInRight">
                <img class="sway_Y__animation" src="{{ asset('public/assets/images/shape/service-bg-shape.png') }}"
                    alt="shape">
            </div>
            <div class="container">
                    ...
                    <div class="col-xl-6">
                        ...
                        <div class="row g-4 wow fadeInDown" data-wow-delay="200ms" data-wow-duration="1500ms">
                            ...
                            <div class="col-md-6">
                                <div class="about__right-item">
                                    <div class="icon">
                                        <img src="{{ asset('public/assets/images/icon/about-icon2.png') }}"
                                            alt="icon">
                                    </div>
                                    <div class="content">
                        ...
                        <div class="about__info mt-50 wow fadeInDown" data-wow-delay="400ms" data-wow-duration="1500ms">
                            <a href="{{ route('contact') }}" class="btn-one">Explore More <i
            ...
            <div class="container">
                ...
                <div class="counter__wrp gradient-bg">
                    ...
                    <div class="counter__item wow bounceInUp" data-wow-delay="00ms" data-wow-duration="1000ms">
                        <img src="{{ asset('public/assets/images/icon/counter-icon1.png') }}" alt="icon">
                        <div class="content">
                    ...
                    <div class="counter__item wow bounceInUp" data-wow-delay="200ms" data-wow-duration="1000ms">
                        <img src="{{ asset('public/assets/images/icon/counter-icon2.png') }}" alt="icon">
                        <div class="content">
                    ...
                    <div class="counter__item wow bounceInUp" data-wow-delay="400ms" data-wow-duration="1000ms">
                        <img src="{{ asset('public/assets/images/icon/counter-icon3.png') }}" alt="icon">
                        <div class="content">
                    ...
                    <div class="counter__item wow bounceInUp" data-wow-delay="800ms" data-wow-duration="1000ms">
                        <img src="{{ asset('public/assets/images/icon/counter-icon4.png') }}" alt="icon">
                        <div class="content">
                        ...
                        <div class="about-three__left-item">
                            <div class="section-header mb-40">
                                ...
                                <p class="wow fadeInUp" data-wow-delay="400ms" data-wow-duration="1500ms"
                                    ...
                                    It is a long
                                    <b>See the magic of collaboration.</b>
                                    We have a professional team on all Technologies, who are responsible for maintaining the
                                    standards of customer and making reliability. Our people are highly talented and
                                    innovated for giving you the best solution. Our teams are dedicated for providing you
                                    the best and innovative solutions of your business needs and requirements. We have done
                                    some of the great web design and development work and all that works and achievements
                                    would not be possible without our dedicated Web Designing Team!
                            ...
                            <div class="about-three__info bor-bottom pb-30">
                                <div class="row g-4 wow fadeInDown" data-wow-delay="200ms" data-wow-duration="1500ms"
                                    ...
                                    <div class="col-md-6">
                                        <div class="about__right-item">
                                            <div class="icon">
                                                <img src="{{ asset('public/assets/images/icon/about-three-icon1.png') }}"
                                                    alt="icon">
                                            </div>
                                            <div class="content">
                                    ...
                                    <div class="col-md-6">
                                        <div class="about__right-item">
                                            <div class="icon">
                                                <img src="{{ asset('public/assets/images/icon/about-three-icon2.png') }}"
                                                    alt="icon">
                                            </div>
                                            <div class="content">
                    ...
                    <div class="col-xl-6 wow fadeInRight" data-wow-delay="200ms" data-wow-duration="1500ms"
                        ...
                        <div class="about-two__left-item">
                            ...
                            <div class="shape-halper">
                                <img class="sway__animation"
                                    src="{{ asset('public/assets/images/shape/about-circle-helper.png') }}"
                                    alt="shape">
                            </div>
                            <div class="image big-image">
                    ...
                    <div class="col-xl-6">
                        <div class="section-header mb-40">
                            <h5 class="wow fadeInUp" data-wow-delay="00ms" data-wow-duration="1500ms"
                                ...
                                <svg class="me-1" width="20" height="12" viewBox="0 0 20 12" fill="none"
                                    ...
                                    <path
                                        ...
                                        fill="#3C72FC" mask="url(#path-2-inside-1_668_146)"></path>
                                </svg>
                                Coding Standard
                            </h5>
                            <h2 class="wow fadeInUp" data-wow-delay="200ms" data-wow-duration="1500ms"
                            ...
                            <p class="wow fadeInUp" data-wow-delay="400ms" data-wow-duration="1500ms"
                                style="visibility: visible; animation-duration: 1500ms; animation-delay: 400ms; animation-name: fadeInUp;">
                                Aonsectetur
                                <b> Code which is the backbone of the application</b>
                                We provide solution from Startup to Enterprise level company. As a mobile and web app
                                development company, we ensure that you get attention of your target audience and increase
                        ...
                        <div class="about__info mt-50 wow fadeInDown" data-wow-delay="400ms" data-wow-duration="1500ms"
                            style="visibility: visible; animation-duration: 1500ms; animation-delay: 400ms; animation-name: fadeInDown;">
                            <a href="{{ route('services') }}" class="btn-one">services<i
                                    class="fa-regular fa-arrow-right-long"></i></a>
                        </div>
                    </div>
                </div>
                ...
                <div class="row g-4 align-items-center">
                        ...
                        <div class="about-three__left-item">
                            <div class="section-header mb-40">
                                ...
                                <p class="wow fadeInUp" data-wow-delay="400ms" data-wow-duration="1500ms"
                                    ...
                                    <b>— Give your company/services a mobile home.</b>
                                    Having an app can really help you build a larger, loyal customer base. If people really
                                    love your services, they will need an app to keep you close by. The mobile community
                                    keeps growing larger and larger. With the latest advancements in tablets and phones,
                                    user accessibility is vital. The mobile app needs to be faster and more powerful with
                                    each upgrade. This is a wonderful opportunity to get your brand name known.
                    ...
                    <div class="col-lg-7 order-1 order-lg-2">
                        <div class="faq__image about-three__image image wow fadeInRight" data-wow-delay="200ms"
                            ...
                            <img src="{{ asset('public/assets/images/about/app.jpg') }}" alt="image">
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="row g-4">
                    ...
                    <div class="col-lg-4 wow fadeInUp" data-wow-delay="400ms" data-wow-duration="1500ms">
                        <div class="process__item">
                            <div class="process__image">
                                <img src="{{ asset('public/assets/images/process/process-image3.png') }}" alt="image">
                            ...
                            <form action="{{ route('contact.store') }}" method="post" autocomplete="off">
                                ...
                                <div class="row g-3">
                                    ...
                                    <div class="col-sm-6">
                                        ...
                                        <input type="text" id="number" name="phone_no"
