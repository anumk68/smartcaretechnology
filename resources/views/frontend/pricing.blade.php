...
@section('content')
    ...
    <div id="targetElement" class="sidebar-area sidebar__hide">
        ...
        <a href="index.html" class="logo mb-40">
            <img src="{{asset('public/assets')}}/images/logo/logo.svg" alt="logo">
        </a>
                    ...
                    <div class="col-xl-4 col-lg-6 col-md-6 wow fadeInUp" data-wow-delay="00ms"
                        ...
                        <div class="pricing__item">
                            <div class="item-shape">
                                <img src="{{asset('public/assets')}}/images/shape/pricing-item-shape.png" alt="shape">
                            </div>
                            <div class="pricing-head">
                                ...
                                <div class="pricing-icon" data-background="{{asset('public/assets')}}/images/shape/pricing-icon-bg.png">
                                    <img src="{{asset('public/assets')}}/images/icon/pricing-icon1.png" alt="icon">
                                </div>
                            </div>
                            <ul>
                    ...
                    <div class="col-xl-4 col-lg-6 col-md-6 wow fadeInUp" data-wow-delay="200ms"
                        ...
                        <div class="pricing__item">
                            ...
                            <div class="pricing-head">
                                ...
                                <div class="pricing-icon" data-background="{{asset('public/assets')}}/images/shape/pricing-icon-bg.png">
                                    <img src="{{asset('public/assets')}}/images/icon/pricing-icon2.png" alt="icon">
                                </div>
                            </div>
                            <ul>
                                <li>Free 1 5 GB Linux Hosting</li>
                    ...
                    <div class="col-xl-4 col-lg-6 col-md-6 wow fadeInUp" data-wow-delay="400ms"
                        ...
                        <div class="pricing__item">
                            ...
                            <div class="pricing-head">
                                ...
                                <div class="pricing-icon" data-background="{{asset('public/assets')}}/images/shape/pricing-icon-bg.png">
                                    <img src="{{asset('public/assets')}}/images/icon/pricing-icon3.png" alt="icon">
                                </div>
                            </div>
                            <ul>
                                <li>Free 1 5 GB Linux Hosting</li>
